define(['app'], function (app) {
    app.controller("IVCRegistrationController", function ($scope, $http, $crypto, $localStorage, $state, $uibModal) {
        const $ctrl = this;
    ...
    //        var submitstddetails = StudentRegistrationService.SubmitStdDetails($scope.StudentName, $scope.MobileNumber, $scope.CasteCategoryID, $scope.Aadhaar, $scope.CasteNum, $scope.CasteVerified, $scope.email, EncriptedPassword, $scope.DataType);
