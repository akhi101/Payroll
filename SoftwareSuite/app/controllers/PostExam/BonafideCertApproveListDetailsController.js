define(['app'], function (app) {
    app.controller("BonafideCertApproveListDetailsController", function ($scope, $http, $localStorage, $state, DigitalSignatureService, $stateParams, AppSettings, $uibModal, $timeout, PreExaminationService) {
