define(['app'], function (app) {
    app.controller("DiplomaStudentResultController", function ($scope, $http, $localStorage, $state, AppSettings, StudentResultService, Excel, $timeout) {
        $scope.examtype = "";
        $scope.sem = "";
        ...
        $scope.hidePreviousResult = function () {
            ...
            $scope.Submit = function () {
                ...
                if ($scope.scheme.schemeid == '5' || $scope.scheme.schemeid == '9') {
                    $scope.ResultFound = false;
                    $scope.LoadImg = true;
                    if (($scope.examtype == '1' || $scope.examtype == '2' || $scope.examtype == '28' ||  $scope.examtype == '29') && $scope.SelStudentType.id == 1) {
