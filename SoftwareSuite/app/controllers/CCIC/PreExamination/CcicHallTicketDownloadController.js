define(['app'], function (app) {
    app.controller("CcicHallTicketDownloadController", function ($scope, $http, $localStorage, $state, $stateParams, AppSettings, PreExaminationService, CcicPreExaminationService, CcicStudentRegistrationService, $uibModal, PaymentService) {
        ...
        $scope.StudentTypes = [{ "ID": 1, "Value": "Regular" }, { "ID": 2, "Value": "Backlog" }]
