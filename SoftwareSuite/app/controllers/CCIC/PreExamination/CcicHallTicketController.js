define(['app'], function (app) {
    app.controller("CcicHallTicketController", function ($scope, $localStorage, CcicPreExaminationService) {
        ...
        $scope.getHallTkt = function () {
            ...
            var getHallticket = CcicPreExaminationService.GetCandidateHallticket(tmpData.AcademicYearID, tmpData.ExamMonthYearID, tmpData.StudentTypeID, tmpData.StudentID);
