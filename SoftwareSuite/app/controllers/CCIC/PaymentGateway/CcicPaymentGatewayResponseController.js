define(['app'], function (app) {
    app.controller("CcicPaymentGatewayResponseController", function ($scope, $http, $localStorage, $state, $stateParams, $interval, AppSettings, PaymentService, PreExaminationService) {
        $scope.success = false;
                ...
                if (detail.Refno != null && detail.Refno != undefined && detail.Refno != "" && $scope.Detailsfound == false) {
                    ...
                    s2sresponsedata.then(function (res) {
                        ...
                        if (res.Table.length > 0) {
                            ...
                            $scope.FeeType = res.Table[0].addtninfo5;
        ...
        $scope.back = function () {
            if ($localStorage.CcicPaymentGatewayResponse.redirecturl != null && $localStorage.CcicPaymentGatewayResponse.redirecturl != undefined) {
