define(['app'], function (app) {
    app.controller("CcicCircularsController", function ($scope, $http, $localStorage, $state, AppSettings, CcicAdminService) {
        ...
        $ctrl.$onInit = () => {
            ...
            //$scope.usertypes()
            //   var usertypeid = 1
            var getcirculartype = CcicAdminService.getCcicCircularTypes();
        ...
        $scope.SaveData = function () {
            ...
            var uploadexcl = AdminService.uploadFile($scope.addpdffile, file.value.split("\\").pop(), $scope.Description, $scope.CircularType, notificationdate);
            uploadexcl.then(function (res) {
                if (res[0].Code == '200') {
                    $scope.loading = false;
                    //$scope.error = false;
