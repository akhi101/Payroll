define(['app'], function (app) {
    app.controller("CcicResultsProcessingController", function ($scope, $http, $localStorage, $rootScope, $state, $stateParams, $document, CcicPreExaminationService, AppSettings, $timeout) {
