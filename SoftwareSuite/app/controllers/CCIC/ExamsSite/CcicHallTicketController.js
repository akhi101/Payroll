define(['app'], function (app) {
    app.controller("CcicHallTicketController", function ($scope, $http, $localStorage, $window, $state, $stateParams, AppSettings, MarksEntryService, $uibModal, PaymentService, PreExaminationService) {
