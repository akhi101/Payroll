define(['app'], function (app) {
    ...
    app.controller("TheoryMarksEntryEventListController", function ($scope, $http, $localStorage,$location, $state, $stateParams, AppSettings, MenuService, AssessmentService) {
