define(['app'], function (app) {
    app.controller("StudentCertificateApproveListDetailsController", function ($scope, $q, $http, $localStorage, $state, DigitalSignatureService, $stateParams, AppSettings, $uibModal, $timeout, PreExaminationService) {
        ...
        $scope.sensSMS = function (PIN, Path, mobile, ind) {
            if ($scope.UserTypeId == 1007 || $scope.UserTypeId == 1002 || $scope.UserTypeId == 1009) {
                ...
                var sensSMS = PreExaminationService.sendcertSMS(PIN, Path, mobile, "Interim");
