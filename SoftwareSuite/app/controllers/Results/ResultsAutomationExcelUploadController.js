define(['app'], function (app) {
    app.controller("ResultsAutomationExcelUploadController", function ($scope, $http, $localStorage, $rootScope, $state, $stateParams, $document, StudentResultService, AppSettings, $timeout, PreExaminationService, AssessmentService, StudentWiseService) {
