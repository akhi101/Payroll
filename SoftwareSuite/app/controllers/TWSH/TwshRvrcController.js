define(['app'], function (app) {
    app.controller("TwshRvrcController", function ($scope, $http, $localStorage, $rootScope, $state, $stateParams, $document, TwshStudentRegService, StudentResultService, AppSettings, $timeout, PreExaminationService, AssessmentService, StudentWiseService) {
        ...
        $scope.UploadExcel = function () {
            ...
            $scope.Exceldat.forEach(function (element) {
                var obj = {
                    "HallTicket": element.HallTicket, "P1Marks": element.P1Marks, "P2Marks": element.P2Marks
                }
        ...
        $scope.UploadWantingsExcel = function () {
            ...
            var uploadJson = TwshStudentRegService.TwshRvRcMarksUploadandResultsProcessing($scope.Wantingsmonthyear, filteredArray1, $scope.userName);
            uploadJson.then(function (data) {
        ...
        $scope.Download = function () {
            ...
            window.location.href = location + '/Results/TWSH_RvRc_Sample_Format.xlsx';
