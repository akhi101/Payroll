define(['app'], function (app) {
    app.controller("TwshApprovalListDetailsController", function ($scope, $state, TwshStudentRegService, $window, $timeout, Excel, $localStorage, PreExaminationService, DigitalSignatureService, $uibModal) {
        ...
        $scope.DownloadtoExcel = function (tableid) {
            ...
            var exportHref = Excel.tableToExcel(tableid, 'Twsh_CBT_results');
            $timeout(function () {
                var a = document.createElement('a');
                a.href = exportHref;
                a.remove();
                a.download = "Twsh_CBT_results.xls";
