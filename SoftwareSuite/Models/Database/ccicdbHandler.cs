...
namespace SoftwareSuite.Models.Database
{
    ...
    public class ccicdbHandler
    {
        ...
        public ccicdbHandler(bool WithTransaction = false, System.Data.IsolationLevel IsolationLevel = System.Data.IsolationLevel.ReadCommitted)
        {
            try
            {
        ...
        public string GetConnectionString()
        {
            try
            {
                ...
                string ConnString = "Data Source=" + appSettings["ccicdbservername"] + ";Initial Catalog=" + appSettings["ccicdatabasename"] + ";User ID=" + ConfigurationManager.AppSettings["ccicDbUserName"].ToString() + "; Password=" + ConfigurationManager.AppSettings["ccicDbUserPassword"].ToString() + ";Max Pool Size=20000";
                return ConnString;
            }
            catch (Exception ex)
            {
