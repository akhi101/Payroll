...
using PayRoll.Models.Certificate;
...
namespace PayRoll.Controllers.StudentServices
{
    public class GenerateCertificate
    {
        ...
        public class EmployeeData
        {
            ...
            public double TGINCR { get; set; }
            public double CA { get; set; }
            public double MA { get; set; }
            public double GrossTotal { get; set; }
            public double NPS_CPS { get; set; }
        ...
        //public string GetPayslipPdf(ds)
        //{
...
<b class='border_btm'>{{FatherName == null ? '______________':FatherName}}</b>
        ...
        public string GetConsolidatedReport(DataSet IntrmData)
        {
...
padding:1px!important;
     ...
     <div class='marginData'>
                        <div class='row'>
                            <div class='col-md-3'>
                                <div><b class='border_btm'>EMPID</b> : 1907259</div>                               
                            </div>
                            <div class='col-md-3'>          
                                 <div><b class='border_btm'>EMPLOYEE NAME</b> : 1907259</div> 
                            </div>
                             <div class='col-md-3'>          
                                 <div><b class='border_btm'>DESIGNATION</b> : 1907259</div> 
                            </div>
                            <div class='col-md-3'>          
                                 <div><b class='border_btm'>EMDESIGNATIONPID</b> : 1907259</div> 
                            </div>
                        </div>
                      <div class='row'>
            ...
            page += $@" <div class='row'>
                <table class='table'>
                    <thead>
                        <tr>
                            <th class='text-center' rowspan='2'  border: 1px solid #000000 !important;'>S.No</th>
                            <th class='text-center' rowspan='2'  border: 1px solid #000000 !important;'>Month Year</th>
                            <th class='text-center' rowspan='2'  border: 1px solid #000000 !important;'>DESCR</th>
                            <th class='text-center' colspan='2' border: 1px solid #000000 !important;'>Pay</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>DA</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>HRA</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>DAArr+<br>NCI</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>SPL</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>TI</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>Conv<br>Allo</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>CCA</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>Medical<br> Allow</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>Gross</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>Ptax</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>TSGLI</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>LIC/PLI</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>GPF</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>GIS</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>HBA</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>HBA1</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>HBA INTR</th>
<th class='text-center' colspan='2' border: 1px solid #000000 !important;'>Tot ITDeductions</th>
                        </tr>
                    </thead>
                    <tbody>";
