...
namespace PayRoll.Models.CBT
{
    public class CbtCrypt
    {
        private readonly string encryptionKey;
        private static byte[] keyAndIvBytes;
        public CbtCrypt(string key = "HBSBP9214EDU00TS")
        {
            encryptionKey = key;
            keyAndIvBytes = Encoding.UTF8.GetBytes(key);
        }
        public string CbtEncrypt(string clearText)
        {
        ...
        public string CbtDecrypt(string cipherText)
        {
        ...
        internal string CbtEncrypt(object p)
        {
