...
namespace PayRoll.Models.IVC
{
    public class IVCCrypt
    {
        private readonly string encryptionKey;
        private static byte[] keyAndIvBytes;
        public IVCCrypt(string key = "HBSBP9214EDU00TS")
        {
            encryptionKey = key;
            keyAndIvBytes = Encoding.UTF8.GetBytes(key);
        }
        public string IVCEncrypt(string clearText)
        {
        ...
        public string IVCDecrypt(string cipherText)
        {
        ...
        internal string IVCEncrypt(object p)
        {
