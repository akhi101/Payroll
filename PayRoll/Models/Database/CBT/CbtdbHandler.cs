...
namespace PayRoll.Models.Database.CBT
{
    public class CbtdbHandler
    {
        ...
        public CbtdbHandler(bool WithTransaction = false, System.Data.IsolationLevel IsolationLevel = System.Data.IsolationLevel.ReadCommitted)
        {
            try
            {
        ...
        public string GetConnectionString()
        {
            try
            {
                ...
                string ConnString = "Data Source=" + appSettings["CbtDBServerName"] + ";Initial Catalog=" + appSettings["CbtDatabaseName"] + ";User ID=" + ConfigurationManager.AppSettings["CbtDbUserName"].ToString() + "; Password=" + ConfigurationManager.AppSettings["CbtDbUserPassword"].ToString() + ";Max Pool Size=20000";
                return ConnString;
            }
            catch (Exception ex)
            {
