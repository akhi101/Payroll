...
namespace PayRoll.Models.Database
{
    public class Twshdbandler
    {
        ...
        public Twshdbandler(bool WithTransaction = false, System.Data.IsolationLevel IsolationLevel = System.Data.IsolationLevel.ReadCommitted)
        {
            try
            {
        ...
        public string GetConnectionString()
        {
            try
            {
                ...
                string ConnString = "Data Source=" + appSettings["TwshDBServerName"] + ";Initial Catalog=" + appSettings["TwshDatabaseName"] + ";User ID=" + ConfigurationManager.AppSettings["TwshDbUserName"].ToString() + "; Password=" + ConfigurationManager.AppSettings["TwshDbUserPassword"].ToString() + ";Max Pool Size=20000";
                return ConnString;
            }
            catch (Exception ex)
            {
