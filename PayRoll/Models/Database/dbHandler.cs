...
namespace PayRoll.Models.Database
{
    public class dbHandler
    {
        ...
        public dbHandler(bool WithTransaction = false, System.Data.IsolationLevel IsolationLevel = System.Data.IsolationLevel.ReadCommitted)
        {
            try
            {
        ...
        public string GetConnectionString()
        {
            try
            {
                ...
                string ConnString = "Data Source=" + appSettings["DBServerName"] + ";Initial Catalog=" + appSettings["DatabaseName"] + ";User ID=" + ConfigurationManager.AppSettings["UserName"].ToString() + "; Password=" + ConfigurationManager.AppSettings["UserPassword"].ToString() + ";Max Pool Size=5000";
